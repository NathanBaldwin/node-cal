...
let day = 0;
 ...
 function makeLengthArray (year, month, requestedDay) {
  ...
  function arrayToString (year, month, requestedDay) {
    ...
    let week1 = numString.substring(0,21);
    let week2 = "\n" + numString.substring(21,42);
    let week3 = "\n" + numString.substring(42,63);
    let week4 = "\n" + numString.substring(63,84);
    let week5 = "\n" + numString.substring(84,105);
    let week6 = "\n" + numString.substring(105, 126);
    console.log("week 5:", week5);

    console.log(week1 + week2 + week3 + week4 + week5);
